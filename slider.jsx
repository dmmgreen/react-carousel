...
export default class Slider extends React.Component {
    ...
    render() {
        var _this=this;
        var slides=this.props.slides;
        var slide=slides.map(function(value,index){
           return (
               <Slide key={index} background={slide.background} active={index === _this.state.activeSlide} link={slide.link} />
           );
        });
        return (
            <div className="slider">
...
class Slide extends React.Component{
    render(){
        var backgound=this.props.background,
        ...
        return(
            <a href={link} >
                <div className="slider__slide" style={slideStyle} data-active={active}>
                </div>
            </a>
        );
    }
